...
/**
 * Un oggetto OperatoreSelezionatoreBean rappresenta un utente loggato al sistema AlmaLaborisSuite.
 ...
 */
public class OperatoreSelezionatoreBean extends UtenteBean implements Serializable {

	private static final long serialVersionUID = 1L;
	
	/**
	 * Costruttore vuoto di OperatoreSelezionatoreBean
	 */
	public OperatoreSelezionatoreBean() {
		super();
	}
	 ...
	 */
	public OperatoreSelezionatoreBean(String email, String ruolo, String nome, String cognome, String telefono, String indirizzo, 
	...
	public String toString() {
		return "OperatoreSelezionatoreBean: "+super.toString();
	}
