...
/**
 * Un oggetto OperatoreSegreteriaBean rappresenta un utente loggato al sistema AlmaLaborisSuite.
 ...
 */
public class OperatoreSegreteriaBean extends UtenteBean implements Serializable {

	private static final long serialVersionUID = 1L;
	
	/**
	 * Costruttore vuoto di OperatoreSegreteriaBean
	 */
	public OperatoreSegreteriaBean() {
		super();
	}

	/**
	 * Costruttore di OperatoreSegreteriaBean
	 * 
	 ...
	 */
	public OperatoreSegreteriaBean(String email, String ruolo, String nome, String cognome, String telefono, String indirizzo, 
	...
	public String toString() {
		return "OperatoreSegreteriaBean: "+super.toString();
	}
