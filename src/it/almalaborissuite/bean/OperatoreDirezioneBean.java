...
/**
 * Un oggetto OperatoreDirezioneBean rappresenta un utente loggato al sistema AlmaLaborisSuite.
 ...
 */
public class OperatoreDirezioneBean extends UtenteBean implements Serializable {

	private static final long serialVersionUID = 1L;
	
	/**
	 * Costruttore vuoto di OperatoreDirezioneBean
	 */
	public OperatoreDirezioneBean() {
		super();
	}

	/**
	 * Costruttore di OperatoreDirezioneBean
	 * 
	 ...
	 */
	public OperatoreDirezioneBean(String email, String ruolo, String nome, String cognome, String telefono, 
	...
	public String toString() {
		return "OperatoreDirezioneBean: "+super.toString();
	}
