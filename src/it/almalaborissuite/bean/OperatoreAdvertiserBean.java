...
/**
 * Un oggetto OperatoreAdvertiserBean rappresenta un utente loggato al sistema AlmaLaborisSuite.
 ...
 */
public class OperatoreAdvertiserBean extends UtenteBean implements Serializable {

	private static final long serialVersionUID = 1L;
	
	/**
	 * Costruttore vuoto di OperatoreAdvertiserBean
	 */
	public OperatoreAdvertiserBean() {
		super();
	}

	/**
	 * Costruttore di OperatoreAdvertiserBean
	 * 
	 ...
	 */
	public OperatoreAdvertiserBean(String email, String ruolo, String nome, String cognome, String telefono, String indirizzo, 
	...
	public String toString() {
		return "OperatoreAdvertiserBean: "+super.toString();
	}
