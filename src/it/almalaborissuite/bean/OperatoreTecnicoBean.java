...
/**
 * Un oggetto OperatoreTecnicoBean rappresenta un utente loggato al sistema AlmaLaborisSuite.
 ...
 */
public class OperatoreTecnicoBean extends UtenteBean implements Serializable {

	private static final long serialVersionUID = 1L;
	
	/**
	 * Costruttore vuoto di OperatoreTecnicoBean
	 */
	public OperatoreTecnicoBean() {
		super();
	}
	 ...
	 */
	public OperatoreTecnicoBean(String email, String ruolo, String nome, String cognome, String telefono, String indirizzo, 
	...
	public String toString() {
		return "OperatoreTecnicoBean: "+super.toString();
	}
