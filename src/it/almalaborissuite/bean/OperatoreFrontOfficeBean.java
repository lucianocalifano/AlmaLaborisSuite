...
/**
 * Un oggetto OperatoreFrontOfficeBean rappresenta un utente loggato al sistema AlmaLaborisSuite.
 ...
 */
public class OperatoreFrontOfficeBean extends UtenteBean implements Serializable {

	private static final long serialVersionUID = 1L;
	
	/**
	 * Costruttore vuoto di OperatoreFrontOfficeBean
	 */
	public OperatoreFrontOfficeBean() {
		super();
	}

	/**
	 * Costruttore di OperatoreFrontOfficeBean
	 * 
	 ...
	 */
	public OperatoreFrontOfficeBean(String email, String ruolo, String nome, String cognome, String telefono, 
			String indirizzo, String cap, String citta, String provincia, LocalDateTime dataNascita, File note) {
		super(email, ruolo, nome, cognome, telefono, indirizzo, cap, citta, provincia, dataNascita, note);
	}

	@Override
	public String toString() {
		return "OperatoreFrontOfficeBean: "+super.toString();
	}
