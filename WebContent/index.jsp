<%@page import="it.almalaborissuite.bean.UtenteBean"%>
...
<html>
	<head>
		...
		<!-- FAVICONS -->
		<link rel="shortcut icon" href="img/favicon-suite.png" type="image/x-icon">
		<link rel="icon" href="img/favicon-suite.png" type="image/x-icon">
	...
	<body>
		...
		<header id="header">
			<div id="logo-group">
				...
				<span id="logo">
					<img src="img/logo-suite.png" alt="AlmaLaborisSuite">
				</span>
