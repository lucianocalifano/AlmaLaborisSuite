	...
	<body>
		...
		<header id="header">
			<div id="logo-group">
				...
				<span id="logo"> <img src="img/logo-suite.png" alt="ChooseIT"> </span>
			...
			<menu id="navSup">
				...
				%>
  				...
  				<li><a href="<%=urlAreaPersonale%>">Area Personale</a></li>
				...
				<li><a href="<%=urlProfilo%>">Profilo</a></li>
				...
				%>
  				...
  				<li id="lastElem"><a id="lastAncor" href="<%=urlContatti%>">Contatti</a></li>
  				
				</ul>
			</menu>
				
				<!-- QUI ANDAVANO LE SEMPLICI ANCORE -->
